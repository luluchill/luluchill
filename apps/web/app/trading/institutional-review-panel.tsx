    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="relative">
        <div className="absolute inset-0 z-0">
          <Image src="/placeholder.svg?height=600&width=1600" alt="City skyline" fill className="object-cover" />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-2">
              <div className="bg-[#F5F2EA] bg-opacity-90 rounded-lg p-4 h-full">
                <h2 className="text-xl font-bold text-[#2C2A25] mb-3">Find Properties</h2>
                {/* Search Input */}
                <div className="mb-3">
                  <div className="flex">
                    <input
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 mb-3">
                  <div>
                    <label className="block text-sm font-medium text-[#2C2A25] mb-1">County/City</label>
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#2C2A25] mb-1">Township/District</label>
                    <select className="w-full p-2 border border-[#D4C19C] rounded-md bg-white text-sm">
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#2C2A25] mb-1">Property Type</label>
                    <select className="w-full p-2 border border-[#D4C19C] rounded-md bg-white text-sm">
                ...
                <div className="grid grid-cols-2 gap-2 mb-3">
                  <div>
                    <label className="block text-sm font-medium text-[#2C2A25] mb-1">Token Price (USDT)</label>
                    <div className="flex items-center">
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="block text-sm font-medium text-[#2C2A25] mb-1">Size (Acre)</label>
                    <div className="flex items-center">
                      <input
                        type="text"
                        className="w-full p-2 border border-[#D4C19C] rounded-l-md text-sm"
                ...
                <div className="flex justify-between items-center">
                  <div>
                    <button className="text-sm text-[#2C2A25] underline">Advanced</button>
                  </div>
                  <div>
                    <button className="bg-[#2C2A25] text-white px-3 py-2 rounded-md text-sm">Apply Filters</button>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="bg-[#F5F2EA] bg-opacity-90 rounded-lg p-4 h-full">
                <h2 className="text-lg font-bold text-[#2C2A25] mb-3">Top 5 Market Cap</h2>
                <div className="bg-white rounded-lg p-3">
                  <div className="overflow-hidden rounded-lg">
                    <table className="min-w-full">
                      <thead className="bg-[#2C2A25] text-white">
                        <tr>
                          <th className="py-1 px-1 text-left text-xs font-medium">#</th>
                          <th className="py-1 px-1 text-left text-xs font-medium">Token</th>
                          <th className="py-1 px-1 text-right text-xs font-medium">Price</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-200">
                        {getTopMarketCap().map((property, index) => (
                          <tr
                            ...
                            onClick={() =>
                              property.id.toString().includes("placeholder") ? null : openModal(property)
                            }
                          >
                              ...
                              {property.id.toString().includes("placeholder") ? (
                                ...
                                <div>
                                  <div className="flex items-center">
                                    ...
                                    <span className="text-xs font-medium">{property.abbr}</span>
                                  </div>
                                  <div className="text-xs text-gray-500 ml-4">
                                  ${property.totalValue} </div>
                                </div>
                              )}
                            </td>
                            <td className="py-1 px-1 text-xs text-right">
                              {property.id.toString().includes("placeholder") ? "" : `${property.tokenPrice} USDT`}
                            </td>
                          </tr>
                        ))}
                      </tbody>
            ...
            <div className="lg:col-span-1">
              <div className="bg-[#F5F2EA] bg-opacity-90 rounded-lg p-4 h-full">
                <div className="flex justify-between items-center mb-3">
                  <h2 className="text-lg font-bold text-[#2C2A25]">{showGainers ? "Top Gainers" : "Top Losers"}</h2>
                  <div className="flex items-center bg-white rounded-full p-0.5">
                    <button
                      className={`px-2 py-0.5 text-xs rounded-full ${
                        showGainers ? "bg-[#2C2A25] text-white" : "text-[#2C2A25]"
                      }`}
                    ...
                    <table className="min-w-full">
                      <thead className="bg-[#2C2A25] text-white">
                        <tr>
                          <th className="py-1 px-1 text-left text-xs font-medium">#</th>
                          <th className="py-1 px-1 text-left text-xs font-medium">Token</th>
                          <th className="py-1 px-1 text-right text-xs font-medium">24h</th>
                        </tr>
                      </thead>
                      <tbody className="divide-y divide-gray-200">
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="text-sm text-gray-600 mb-3">
                    ...
                    <div className="text-xs mt-1 font-mono">Contract: {property.contract}</div>
                  </div>
                  <div className="grid grid-cols-3 gap-2 mt-3 border-t pt-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium">{property.totalTokens}</div>
                    </div>
                    <div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center">
          ...
          <div className="relative bg-white rounded-lg w-full max-w-5xl mx-4 flex flex-col max-h-[90vh] overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-5 gap-2 p-3 overflow-auto">
              ...
              <div className="col-span-3 overflow-y-auto pr-2" style={{ maxHeight: "80vh" }}>
                ...
                <div className="mt-2">
                    ...
                    <div className="bg-[#F5F2EA] p-1.5 rounded-md">
                      ...
                      <div className="text-xs">
                        ...
                        <div className="flex justify-between py-0.5">
                          ...
                          <span>RWA-{selectedProperty.id.toString().padStart(6, "0")}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-[#F5F2EA] p-1.5 rounded-md">
                    ...
                    <p className="text-xs text-gray-600">
                      ...
                      tokenized into {selectedProperty.totalTokens} tokens, each representing partial ownership.
                      Investors can purchase tokens to gain exposure to this real estate asset without having to buy the
                      entire property.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-white rounded-lg p-2 mb-2 flex-1">
                  ...
                  <div className="mb-1.5">
                    ...
                    <div className="flex items-center bg-[#F5F2EA] p-2 rounded-lg">
                      <input
                        ...
                        value={usdtAmount}
                        onChange={(e) => {
                          const usdtAmount = Number.parseFloat(e.target.value) || 0
                          setUsdtAmount(usdtAmount)
                          setTokenQuantity(usdtAmount / selectedProperty.tokenPrice)
                        }}
                  ...
                  <div className="mb-1.5">
                    ...
                    <div className="flex items-center bg-[#F5F2EA] p-2 rounded-lg">
                      <input
                        ...
                        value={tokenQuantity}
                        onChange={(e) => {
                          setTokenQuantity(Number.parseFloat(e.target.value) || 0)
                          setUsdtAmount(Number.parseFloat(e.target.value) * selectedProperty.tokenPrice)
                        }}
                        className="bg-transparent outline-none flex-1 text-base font-medium"
                        placeholder="0.0"
                      />
                      <div className="flex items-center bg-white py-0.5 px-2 rounded-md ml-2">
                        ...
                        <span className="font-medium text-sm">{selectedProperty.abbr}</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-2 bg-[#F5F2EA] p-1.5 rounded-lg">
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="font-medium">
                        1 {selectedProperty.abbr} = {selectedProperty.tokenPrice} USDT
                      </span>
                    </div>
                    <div className="flex justify-between text-xs">
                  ...
                  <div className="mt-1.5 bg-[#F5F2EA] p-1.5 rounded-lg">
                    ...
                    <div className="flex justify-between text-xs">
                      ...
                      <span className="font-medium">{selectedProperty.totalValue} USDT</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-2 text-xs text-gray-500">
                    <div className="flex justify-between">
                      ...
                      <span>
                        {(tokenQuantity * 0.995).toFixed(4)} {selectedProperty.abbr}
                      </span>
                    </div>
                    <div className="flex justify-between">
